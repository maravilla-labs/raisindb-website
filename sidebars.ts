      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            'guides/querying/graph-algorithms',
        ...
        },
        {
          ...
          label: 'Integrations',
          items: [
            'guides/integrations/sync-google-drive',
            'guides/integrations/sync-a-mailbox',
            'guides/integrations/connect-gmail',
            'guides/integrations/connect-microsoft-365',
            'guides/integrations/sync-google-calendar',
            'guides/integrations/realtime-sync-webhooks',
            'guides/integrations/build-a-custom-adapter',
          ],
        },
